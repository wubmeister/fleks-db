 ...
 */
class Insert extends Buildable
{
    const EXCEPTION = 0;
    const IGNORE = 1;
    const UPDATE = 2;
     ...
     *
     * @param bool $ignore The ignore flag. Defaults to true. Provide false to cancel ignoring.
     * @return static Provides method chaining
     */
     ...
     *
     * @param int $action One of the class constants: EXCEPTION, IGNORE, UPDATE.
