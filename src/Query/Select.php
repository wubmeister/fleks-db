 ...
 */
class Select extends Buildable
{
    /**
     * The joins
     * @var array
     ...
     * @param bool $replaceAll If true, this will replace all existing columns
     *   in the query with the specified ones. Defaults to false.
     * @return static Provides method chaining
     */
     ...
     *   with one element. In case of an array, the element's key should be the
     *   alias and the value the real table name.
     * @param string $condition The condition on which to join on
     * @param string|array $columns The column(s) to select from the table. Defaults to '*'.
     * @param string|null $method The join method, e.g. 'LEFT', 'INNER', 'RIGHT'
     * @return static Provides method chaining
     */
     ...
     *
     * @param string|array $group One or multiple columns to group by
     * @return static Provides method chaining
     */
     ...
     *
     * @param string|array $order One or multiple columns to order by
     * @return static Provides method chaining
     */
